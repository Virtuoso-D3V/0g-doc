...
- [Protocol Documentation](#protocol-documentation)
  ...
  - [disperser.proto](#disperserproto)
    - [BatchHeader](#batchheader)
    - [BatchMetadata](#batchmetadata)
    - [BlobHeader](#blobheader)
    - [BlobInfo](#blobinfo)
    - [BlobQuorumParam](#blobquorumparam)
    - [BlobStatusReply](#blobstatusreply)
    - [BlobStatusRequest](#blobstatusrequest)
    - [BlobVerificationProof](#blobverificationproof)
    - [DisperseBlobReply](#disperseblobreply)
    - [DisperseBlobRequest](#disperseblobrequest)
    - [RetrieveBlobReply](#retrieveblobreply)
    - [RetrieveBlobRequest](#retrieveblobrequest)
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| commitment_root | [bytes](#bytes) |  | Merkle root of KZG commitments of blob. |
...
| data_root | [bytes](#bytes) |  | The data merkle root |
| epoch | [uint32](#uint32) |  | Signers epoch |
| quorum_id | [uint32](#uint32) |  | Signers quorum id |
...
| target_row_num | [uint32](#uint32) |  | The number of rows that encoded blob split into. The number will be aligned to the next power of 2 and be bounded by blob size. |
