...
We provide a [SDK](../0g-storage/sdk/) for users to easily integrate 0G Storage in their applications with the following features:
...
Please refer to [Deployment page](broken-reference) for detailed steps to compile and start a 0G Storage node.
